    ...
    <>
        ...
        <div className="grid grid-cols-6 text-center py-10">
          <div className="col-start-2 col-span-4">
            <h1 className="text-6xl font-bold">Records</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          ...
          <div className="shadow-lg hover:shadow-xl cursor-pointer px-8 py-4 rounded-lg hover:scale-105 transition-all">
            <h1 className="text-3xl font-bold text-gray-700 text-center">
              Black Hole ~BangChan & I.N
            </h1>
            <div className="flex justify-center py-6">
              <Image
                src="/skz_sty/record1.jpg"
                alt="albums"
                width={258}
                height={258}
                className="py-6"
          ...
          <div className="shadow-lg hover:shadow-xl cursor-pointer px-8 py-4 rounded-lg hover:scale-105 transition-all">
            <h1 className="text-3xl font-bold text-gray-700 text-center">
              Love Me Or Leave Me ~LeeKnow
            </h1>
            <div className="flex justify-center py-6">
              <Image
                src="/skz_sty/record2.jpg"
                alt="albums"
                width={285}
                height={285}
                className="py-6"
